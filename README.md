...
#### generalmissile-based ####
  ...
  * [dualprofile](https://tyrannyofheaven.org/ZerothAngel/FtDScripts/dualmissile.lua) &mdash; Dual-profile missile script, using a separate generalmissile instance for vertically- and horizontally-launched missiles.
  ...
  * [multiprofile](https://tyrannyofheaven.org/ZerothAngel/FtDScripts/multimissile.lua) &mdash; Multiple profile missile script, up to one generalmissile instance for each weapon slot.
