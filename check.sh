...
for f in airship cameratrack dediblademaintainer drop dropquad gunshipquad interceptmanager repairquad repairsub scout shieldmanager submarine utility utilitysub warship; do
  luacheck out/$f.lua
done
